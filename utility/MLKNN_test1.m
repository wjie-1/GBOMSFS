function [HammingLoss,RankingLoss,OneError,Coverage,Average_Precision,Outputs,Pre_Labels]=MLKNN_test1(train_data,train_target,test_data,test_target,Num,Prior,PriorN,Cond,CondN)
