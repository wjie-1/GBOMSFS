function [HammingLoss,RankingLoss,Coverage,Average_Precision,OneError,macrof1,microf1,Outputs,Pre_Labels]=MLKNN_test(train_data,train_target,test_data,test_target,Num,Prior,PriorN,Cond,CondN)
